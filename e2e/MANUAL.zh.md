...
2. [CLI 功能测试](#cli-feature-testing)
3. [Web UI 交互测试](#web-ui-interaction-testing)
4. [多轮问答流程测试](#multi-round-qa-workflow-testing)
5. [SSE 实时事件测试](#sse-real-time-event-testing)
6. [错误处理测试](#error-handling-testing)
7. [国际化与主题测试](#internationalization-and-theme-testing)
8. [清理环境](#environment-cleanup)
